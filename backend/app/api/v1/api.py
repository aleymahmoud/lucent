...
# Invites (tenant admin — spec 003 P2)
api_router.include_router(invites.router, prefix="/users", tags=["Invites - Tenant Admin"])
api_router.include_router(invites.public_router, tags=["Invites - Public"])
